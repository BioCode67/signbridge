...
워크스페이스에 배정된 GPU는 `h200-mig-1g.35gb`, 즉 **H200의 MIG 1g 슬라이스**다.
메모리는 35GB로 넉넉하지만 **연산 유닛은 전체의 약 1/7**이다. 이 비대칭이 설계를 결정한다.
...
| ONNX 내보내기 | fp32 2.9MB / **int8 0.82MB**, PyTorch 대비 오차 **2.4e-07** |
