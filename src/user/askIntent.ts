...
const PLACE_WORDS: Record<PlaceKind, string[]> = {
  shelter: ['대피', '도망', '피난', '장소', '학교', '초등학교', '운동장', '지하'],
  hospital: ['병원', '응급실', '구급차', '치료', '진료'],
  pharmacy: ['약국', '약'],
  police: ['경찰서', '경찰', '파출소'],
  subway: ['지하철', '역', '전철'],
  toilet: ['화장실', '변소', '소변', '대변'],
